...
<section class="section section--details section--bg" data-bg="img/section/details.jpg">
    ...
    <div class="container">
        <div class="row">
            <!-- title -->
            <div class="col-12">
                <h1 class="section__title section__title--mb">{{ $tvshow['name'] }}</h1>
            </div>
            <!-- end title -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-8 col-lg-9 col-xl-7">
                            <div class="card__content">
                                <ul class="card__meta">
                                    <li><span>Genre:</span>{{ $tvshow['genres'] }}</li>
                                    <li><span>Release date:</span> {{ $tvshow['first_air_date'] }}</li>
                                    <li><span>Episodes:</span> ({{ $tvshow['episodes'] }} episode)</li>
                                    <li><span>Running time:</span> 130 min</li>
                                    <li><span>Country:</span>{{ $tvshow['country'] }}</li>
                                    {{-- <li><span>Crew:</span>
            ...
            <div class="col-12 col-xl-6">
                ...
                <p class="card__meta">{{ $tvshow['overview'] }}</p>
            </div>
            <!-- end player -->
        </div>
    </div>
